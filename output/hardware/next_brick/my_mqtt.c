...
extern void mqtt_next_brick_callback(struct mosquitto *mosq, void *userdata, const struct mosquitto_message *message);
...
void mqtt_init(char *host, int port, char *user, char *pwd, uint8_t qos, char *id)
{
	...
	mosquitto_message_callback_set(mosq, mqtt_next_brick_callback);
	// LWT konfigurieren
